<?php
	...
	$name = $_POST['name'];
	$sql = "DELETE FROM evaluatortable WHERE evaluatorName='$name'";
	mysqli_query($con, $sql);
	echo "<div id='div1' onclick='sun()'><center>Evaluator succesfully deleted. Go back to home page</center></div>";
	mysqli_close($con);
